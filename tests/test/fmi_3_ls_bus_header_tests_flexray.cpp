...
TEST(Fmi3LsBusFlexRayCombinationTest, maxValues) {
	...
	FMI3_LS_BUS_FLEXRAY_CREATE_OP_CONFIGURATION_FLEXRAY_GLOBAL(&firstBufferInfo, UINT32_MAX, UINT16_MAX, UINT8_MAX, UINT8_MAX,UINT16_MAX, UINT16_MAX, UINT8_MAX, UINT8_MAX, UINT16_MAX, UINT8_MAX, UINT8_MAX, UINT8_MAX, UINT8_MAX, UINT64_MAX, fmi3True);
