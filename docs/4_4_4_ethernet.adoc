...
This standard covers all variants of Ethernet (e.g. 10BASE-T, 100BASE-TX, 1000BASE-T, 10GBASE-T, 100BASE-T1, 1000BASE-T1, 10BASE-T1S, etc.) described in <<IEEE-802.3-2022, IEEE 802.3>> while being flexible enough to support future versions without adaption due to the high cadence of the Ethernet standardization process.
...
Auto-Negotiation on twisted pair (see <<IEEE-802.3-2022, IEEE 802.3>>, section 28, page 933 et seqq.), required for e.g., in 10BASE-T, 100BASE-TX, 1000BASE-T, 10GBASE-T, and Auto-Negotiation for single differential-pair media (see <<IEEE-802.3-2022, IEEE 802.3>>, section 98, page 4049 et seqq.), required in e.g., for 100BASE-T1, 1000BASE-T1, 10BASE-T1S, are supported.
1000BASE-X Auto-Negotiation (see <<IEEE-802.3-2022, IEEE 802.3>>, section 37, page 1492 et seqq.), used for example within 1000BASE-LX and 1000BASE-CX, is currently not explicitly supported.
