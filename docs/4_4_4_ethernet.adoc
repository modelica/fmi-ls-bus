...
<<figure-ethernet-topology-switch-inside-bus-simulation>> illustrates an Ethernet topology in which the switch is integrated within the Bus Simulation.
...
<<figure-ethernet-topology-switch-inside-network-fmu>> illustrates an Ethernet topology in which the switch is integrated within a Network FMU.
