...
- Christine Thiessen, dSPACE GmbH, Germany
- Ella Vahle, dSPACE GmbH, Germany
- Markus Wedler, Synopsys, Germany
...
- [[[ISO-17987-3]]] ISO 17987-3:2025(en):
**Road vehicles — Local Interconnect Network (LIN) - Part 3: Protocol specification**. https://www.iso.org/standard/85127.html
