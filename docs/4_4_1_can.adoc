...
Therefore, a parameter with `memberName = "BusNotifications"` can be added within the !!! CAN-specific Configuration Terminal !!!. +
...
A Bus Simulation FMU shall indicate via a variable with `memberName = "BusNotifications"` within the !!! CAN-specific Configuration Terminals !!! whether it provides bus notifications or not.
