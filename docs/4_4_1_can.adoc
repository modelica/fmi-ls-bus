...
The https://modelica.github.io/fmi-guides/main/ls-bus-guide/#low-cut-can-realization-of-can-error-handling[FMI LS BUS Implementer’s Guide] contains an example how to realize CAN error handling basing on the Bus Operations specified by this layered standard.
