...
For a Network FMU that initiated the <<low-cut-can-transmit-operation, `Transmit Operation`>>, the argument `Is Sender` shall be set to `TRUE` in the corresponding Bus Error operation.
