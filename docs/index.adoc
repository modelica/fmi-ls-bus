...
Each network signal must be listed as <<TerminalMemberVariable>> of its corresponding <<PDUTerminal>> [<<rule_2.2.1a, 2.2.1a>>][[apply_2.2.1a_1]]..
...
Both frame variables must be listed as a <<TerminalMemberVariable>> of its corresponding <<BUSTerminal>> [<<rule_2.2.2a, 2.2.2a>>][[apply_2.2.2a_1]].

Generally, frame variables are optional, but they must either both be missing or present to clearly indicate support for the frame abstraction layer [<<rule_2.2.2a, 2.2.2a>>][[apply_2.2.2a_2]].
