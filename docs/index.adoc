...
# TODO AJ: add use case description for low-cut MCAL transport-layer simulation requirements
...
# TODO AJ: MIME types: org.modelica.fmi-ls-bus.v1.[CAN|CANFD|LIN|FlexRay|Ethernet|SPI]
