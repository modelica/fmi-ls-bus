...
h|Description 
3+|Represents an operation for the transmission of a LIN header from a LIN Master to LIN slaves.
...
|PID 
|1 byte 
|The specified protected ID (PID) of the LIN message.
...
h|Description 
3+|Represents an operation for the transmission of a LIN response from a LIN Slave to the LIN Master.
...
h|Description 
3+|Represents an operation for the transmission of a LIN header and response from a LIN Master to LIN slaves.
...
[#figure-lin-wake-up]
image::images/lin_wake_up.svg[width=700]
