...
This transmission is initiated by the LIN Master in FMU 1 which transmits a LIN Header to FMU 2 via a Bus Simulation using a <<low-cut-lin-transmit-operation, `Transmit`>> operation.
