...
[stem] 
++++
   T_{Tx_{DynamicFirst}}(tc, i_{Cycle}, i_{Slot}) = T_{Tx_{Static}}(tc, i_{Cycle}, N_{StaticSlot} + 1)
...
[stem] 
++++
   T_{Tx_{DynamicLast}}(tc, i_{Cycle}, i_{Slot}) = T_{Tx_{Static}}(tc, i_{Cycle}, N_{StaticSlot} + 1)
