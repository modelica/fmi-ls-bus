...
h|[Flag] Error Flag h|Value h|Description
...
h|Segment Indicator h|Value h|Description
...
h|Coldstart Node h|Value h|Description
...
h|Symbol Type h|Value h|Description
