...
|Coldstart Node
|1 byte
|Specifies if the given FlexRay node represents a coldstart node or not.
...
[stem] 
++++
    T_{CycleStart}(t, i_{Cycle}) = T_{Start} + L_{Cycle} * (ceil((t - T_{Start}) / N_{Cycle}) + i_{Cycle})
++++

, whereby:

* stem:[t] represents the current simulation time in nanoseconds for stem:[t >= T_{Start}]
...
[stem] 
++++
    T_{Tx_{Static}}(t, i_{Cycle}, i_{Slot}) = T_{CycleStart}(t, i_{Cycle}) + (i_{Slot} - 1) * L_{StaticSlot}
++++
...
[stem] 
++++
    T_{Valid} = [ T_{Tx_{Static}}(t, i_{Cycle}, i_{Slot}), T_{Tx_{Static}}(t, i_{Cycle}, i_{Slot}) + T_{ActionPoint_{Static}} ]
++++
...
[stem] 
++++
   T_{Tx_{DynamicFirst}}(t, i_{Cycle}, i_{Slot}) = T_{Tx_{Static}}(t, i_{Cycle}, N_{StaticSlot} + 1)
...
[stem] 
++++
   T_{Tx_{DynamicLast}}(t, i_{Cycle}, i_{Slot}) = T_{Tx_{Static}}(t, i_{Cycle}, N_{StaticSlot} + 1)
...
[stem] 
++++
    T_{Valid} = [ T_{Tx_{DynamicFirst}}(t, i_{Cycle}, i_{Slot}), T_{Tx_{DynamicLast}}(t, i_{Cycle}, i_{Slot}) + T_{ActionPoint_{Dynamic}} ]
++++
