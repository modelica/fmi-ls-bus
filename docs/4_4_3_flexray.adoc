...
* stem:[T_{\mathrm{AP}}(i_{\mathrm{iteration}}, i_{\mathrm{Cycle}}, i_{\mathrm{Slot}})
  = T_{\mathrm{Tx}_{\mathrm{Static}}}(t, i_{\mathrm{Cycle}}, i_{\mathrm{Slot}}) + T_{\mathrm{ActionPoint}_{\mathrm{Static}}}].
* stem:[i_{\mathrm{iteration}}] represents the iteration of complete FlexRay cycles.
...
The interval spans from the action point of slot stem:[i_{\mathrm{Slot}}] in cycle stem:[i_{\mathrm{Cycle}}] of iteration stem:[i_{\mathrm{iteration}}] to the action point of the same slot and cycle in the subsequent iteration stem:[i_{\mathrm{iteration}} + 1].
