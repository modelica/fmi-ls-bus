...
h|Name h|Value h|Description
|NONE|0x0|Not applicable
|MDI|0x1|The MDI is wired in normal configuration.
|MDI_X|0x2|The MDI is wired in crossover configuration.
|AUTO_MDI_X|0x3|The node supports auto MDI/MDI-X.
...
h|Name h|Value h|Description
|NONE|0x0|Not applicable.
|MASTER|0x1|Node is operating as MASTER.
|SLAVE|0x2|Node is operating as SLAVE.
