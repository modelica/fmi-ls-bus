...
This layered standard not only contains a textual specification for bus support, but also provides a C-API to make creation and use within FMUs as easy and generalized as possible.
