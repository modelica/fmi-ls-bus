...
TODO! What does it mean and is it even necessary to mention that the limitations are importer-specific? Isn't it obvious?
...
TODO!! what does this mean? that the importer can have other interfaces? Why is this relevant here at all? I'd just drop the sentence
