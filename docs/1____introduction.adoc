...
Since the Network Abstraction layer is protocol-independent, it can also be used for the simulation of non-automotive control units, e.g., from the field of industrial automation.
...
To keep the standard itself brief, the https://modelica.github.io/fmi-ls-bus-guides/main/ls-bus-guide/[FMI LS BUS Implementer’s Guide] was created.
