...
Alternatively, the input Clocks (`Rx_Clock`) can be `periodic` Clocks matching the relevant Clock of the sending FMU, which causes them to be scheduled for the same time instances.
