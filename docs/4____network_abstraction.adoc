...
|application/org.fmi-standard.fmi-ls-bus.generic.{userdefined}; version="{userdefined}; {protocolversion="{userdefined}"}
|Binary variables simulating an generic network
