...
The following applies for this operation: `Length = 7 + <Arg2_Length>`.
...
|4 byte
|Defines the cumulative length of all arguments in bytes.
The following applies for this operation: `Length = 7 + Length of Data argument in bytes`.
...
|org.fmi-standard.fmi-ls-bus.can; version="1.0.0-alpha.1"
|Binary variables simulating a CAN network including CAN, CAN FD and CAN XL

|org.fmi-standard.fmi-ls-bus.lin; version="1.0.0-alpha.1"
|Binary variables simulating a LIN network

|org.fmi-standard.fmi-ls-bus.flexray; version="1.0.0-alpha.1"
|Binary variables simulating a FlexRay network

|org.fmi-standard.fmi-ls-bus.ethernet; version="1.0.0-alpha.1"
